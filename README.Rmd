...
First, be sure to install [flowCore](https://www.bioconductor.org/packages/release/bioc/html/flowCore.html) from [Bioconductor](https://www.bioconductor.org).
...
Then, you can install the latest version of cytoBatchNorm from [GitHub](https://github.com/) with:
